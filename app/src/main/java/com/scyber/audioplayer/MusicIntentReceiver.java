  ...
  public void onReceive(Context context, Intent intent) {
    if (intent.getAction().equals(android.media.AudioManager.ACTION_AUDIO_BECOMING_NOISY)) {
      ...
      // send an intent to our MusicService to telling it to pause the audio
		  IntentStarter.start(context, MusicService.ACTION_TOGGLE_PLAYBACK);
      ...
      switch (keyEvent.getKeyCode()) {
        ...
        case KeyEvent.KEYCODE_MEDIA_STOP:
          IntentStarter.start(context, MusicService.ACTION_STOP);
          break;
        case KeyEvent.KEYCODE_MEDIA_NEXT:
          IntentStarter.start(context, MusicService.ACTION_NEXT);
          break;
        case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
          // TODO: ensure that doing this in rapid succession actually plays the
          // previous song
          IntentStarter.start(context, MusicService.ACTION_PREVIOUS);
          break;
      }
    }
  }
